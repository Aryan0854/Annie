        ...
        {showCredits && (
          ...
          >
            ...
            <button
              ...
              className="fixed top-6 left-6 z-50 px-4 py-2 bg-white/10 hover:bg-white/20 text-white rounded-md transition-all duration-300 flex items-center gap-2 border border-white/20 hover:border-white/40"
              style={{ fontFamily: 'Arial, sans-serif' }}
            >
